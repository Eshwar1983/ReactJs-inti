      ...
      <div className="List___container">
        <div className="List___header">
          ...
          <div className="List___controls">
            ...
            />
            <button onClick={this.onNewLabelAdd}>
              Add
            </button>
          </div>
...
class reusableListApp extends React.Component {
  constructor (props) {
    super(props);
  ...
  onNewListCreate () {
    ...
    const newListId = lists.length > 0
    ...
    return (
      <div>
        ...
        <div className="App___listsControls">
          ...
          />
          <button onClick={this.onNewListCreate}>
            Create List
          </button>
        </div>
        <hr/>
...
export default reusableListApp;
